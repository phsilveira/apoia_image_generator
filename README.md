# Apoia Image Generator

App to generate images using Midjourney API with our prompts
...
git clone git@github.com:phsilveira/apoia_image_generator.git

# Go to correct directory
cd apoia_image_generator
